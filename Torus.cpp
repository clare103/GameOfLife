...
void Torus::menu()
{
    torus_mode_config_text();
}
void Torus::torus_mode_config_text()
{
    int random =0;
...
void Torus::calculate_random_mode()
{
    if(get_random() == 1)
    {
        enter_dimensions();
...
void Torus::calculate_generation_settings()
{
...
void Torus::calculate_generation_settings_output()
{
...
void Torus::set_random(int a)
{
    random = a;
}
void Torus::set_generation_settings(int a)
{
    generation_settings= a;
}

int Torus::get_random()
{
    return random;
}
int Torus::get_generation_settings()
{
    return generation_settings;
}

void Torus::enter_dimensions()
{
    int r;
...
void Torus::set_file(string a)
{
    file = a;
}
string Torus::get_file()
{
    return file;
}


void Torus::flat_file_config()
{
    string stuff, next2;
    DIR *dir;
    struct dirent *ent;
...
void Torus::set_outfile_name(string a)
{
    outfile_name = a;
}
string Torus::get_outfile_name()
{
    return outfile_name;
}

void Torus::set_myArray(char **b)
{
    **myArray = **b;
}
char** Torus::get_myArray()
{
    return myArray;
}

void Torus::output_gen_tofile(char **a, int height, int width)
{
...
void Torus::pressentertocontinue()
{
    std::cout << "Press ENTER to continue... " << flush;
    std::cin.ignore( std::numeric_limits <std::streamsize> ::max(), '\n' );
}

void Torus::random_board()
{
    srand(time(0));
    char** myArray = 0;
    myArray = new char*[get_height()];
...
void Torus::switchboard(char **a, char **b, int height, int width)
{
...
int Torus::count_x(char **a,int r, int c)
{
    int count =0;
...
void Torus::nextstate(char **a, int height, int width)
{
    char** nextArray = 0;
...
bool Torus::non_trivial(char **a, char **b, int height, int width)
{
    int count = 0;
    for(int i =0; i < height; ++i)
    {
...
void Torus::set_random_number(int r)
{
    random_number = r;
};
int Torus::get_random_number()
{
    return random_number;
}
void Torus::set_random_percent(int r)
{
    random_percent = r;
};
int Torus::get_random_percent()
{
    return random_percent;
}

void Torus::set_width(int n)
{
    width = n+2;
}
void Torus::set_height(int n)
{
    height = n+2;
}
int Torus::get_height()
{
    return height;
}
int Torus::get_width()
